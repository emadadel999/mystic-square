...
const Welcome = (props) => {
  ...
  const getWrapperStyle = () => {
    return isActive ? { height: "300px" } : { height: "0px" };
  };
    ...
    <div className="container">
      ...
      <div className="details-container">
        {width > 992 ? (
          ...
          <>
            <div className="infoContainer" onClick={() => toggleInfo()}>
              <p className="infoText">More info</p>
              <p className="toggleInfo">{isActive ? "-" : "+"}</p>
            </div>
